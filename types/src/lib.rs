...
impl VideoPhase {
    pub fn from_str(s: &str) -> Option<VideoPhase> {
        match s {
            "Pending" => Some(VideoPhase::Pending),
            "Starting" => Some(VideoPhase::Starting),
            "Downloading" => Some(VideoPhase::Downloading),
            "Succeeded" => Some(VideoPhase::Succeeded),
            "Failed" => Some(VideoPhase::Failed),
            _ => None,
        }
    }
    ...
    pub fn to_str(&self) -> &str {
        match self {
            VideoPhase::Pending => "Pending",
            VideoPhase::Starting => "Starting",
            VideoPhase::Downloading => "Downloading",
            VideoPhase::Succeeded => "Succeeded",
...
pub struct VideoStatus {
    // a simple identifier for the Video's state
    pub phase: Option<String>,
